      ...
      <div className="w-full max-w-4xl mx-auto">
        <div className="text-center max-w-xl mx-auto mb-12">
          ...
          <p className="text-sm sm:text-base text-muted">
            ¿Tenés un proyecto en mente, querés colaborar o simplemente saludar?
            Escribime por cualquiera de estos medios o dejame un mensaje.
          </p>
        </div>
            ...
            {items.map((item) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[11px] font-semibold text-muted-subtle uppercase tracking-wider">
                    {item.tipo}
                  </p>
